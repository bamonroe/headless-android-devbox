...
scripts/fdroid-sync-apks.sh     # copy the store's APKs into <fdroid-repo>/repo/
...
| `<fdroid-repo>/metadata/*.yml` | one skeleton file per package, generated by `fdroid update -c` |
